...
OpenCode remains compatibility-only in v2.1.9. It is supported through compatibility MCP wiring and interop diagnostics, but it is not part of the canonical behavior-parity contract set.
