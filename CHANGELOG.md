...
OMG v3.1.0 — "AI Work OS" sub-release. Adds instant front-door workflow, smart routing, goal packs, proof-by-default, universal memory, observability HUD, failure-aware steering, one-click deploy/operate, and persona-aware UX.
