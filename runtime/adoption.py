...
from runtime.canonical_taxonomy import CANONICAL_PRESETS, CANONICAL_PRESETS_SIMPLE, RELEASE_CHANNELS, PRESET_HOOK_COUNT, PRESET_HOOK_MAPPING
...
VALID_PRESETS_SIMPLE = CANONICAL_PRESETS_SIMPLE
VALID_PRESETS_ALL = CANONICAL_PRESETS + CANONICAL_PRESETS_SIMPLE
VALID_RELEASE_CHANNELS = RELEASE_CHANNELS
PRESET_LEVEL: dict[str, int] = {p: i for i, p in enumerate(PRESET_ORDER)}
PRESET_HOOK_COUNT = PRESET_HOOK_COUNT
PRESET_HOOK_MAPPING = PRESET_HOOK_MAPPING
