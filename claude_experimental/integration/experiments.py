...
class ExperimentTracker:
    ...
    def compare(
        ...
        Args:
            experiment_id: Experiment ID from define_experiment().
            metric_name: If provided, restrict comparison to this metric only.
                When an experiment records multiple incompatible metrics (e.g.
                latency_ms and a 0/1 success flag), pass metric_name to avoid
