...
if is_failure:
    ...
    if effective_count >= 5:
        # NOTE: Do NOT call record_stop_block here. That function tracks stop-hook blocks
        # and populates the stop-hook loop tracker. Calling it from circuit-breaker (a PostToolUse hook)
        # would incorrectly affect stop_dispatcher's Guard 4/5 logic after repeated failures.
